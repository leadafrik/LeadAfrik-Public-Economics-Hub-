...
export default function CustomDataRequestForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white border border-gray-200 p-8 my-8 max-w-2xl" aria-label="Custom data request form">
      <h3 className="text-lg font-semibold text-gray-900 mb-6" id="form-title">Custom Data Request</h3>
      ...
      <div className="space-y-4">
        ...
        <div>
          <label htmlFor="dataScope" className="block text-sm font-medium text-gray-700 mb-1">
            Data Scope <span aria-label="required">*</span>
          </label>
          <select
            id="dataScope"
            name="dataScope"
